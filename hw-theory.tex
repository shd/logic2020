...
например, строка $0'=0$ превращается в число $48 + (39 \cdot 256) + (61 \cdot 256^2) + (48 \cdot 256^3)$.
...
\section*{Дополнительное домашнее задание}

В данном разделе предложены дополнительные задачи для желающих добрать баллы. Проверяются отдельно, по договорённости.
\begin{enumerate}
\item Докажите, что $\vdash (a+b)\cdot(a-b) = a^2 - b^2$. Доказательство должно быть формальным, в виде файла,
который будет успешно верифицирован программой из лабораторной С (9 баллов).
\end{enumerate}
